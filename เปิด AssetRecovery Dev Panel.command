#!/bin/zsh
# ดับเบิลคลิกไฟล์นี้เพื่อเปิด AssetRecovery Dev Panel (แผงควบคุม dev แบบกดปุ่ม)
...
echo "กำลังเปิด AssetRecovery Dev Panel ที่ http://localhost:$PORT …"
