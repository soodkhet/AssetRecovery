...
- Code ที่เป็น "เตือน ไม่ block" มี 4 ตัวเท่านั้น: `BANK_ACCOUNT_NAME_MISMATCH`, `DUPLICATE_PAYMENT_FILE`, `ALREADY_MATCHED`, `FILING_OVERDUE_WARNING` (+`IMEI_MISMATCH` ฝั่ง warehouse) — นอกนั้น reject
