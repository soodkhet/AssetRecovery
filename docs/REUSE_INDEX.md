...
| ยาม schema (satang=Int / ห้าม Float / Decimal(5,2) เฉพาะ pct / DateTime ต้องระบุ Timestamptz) | `prisma/schema.test.ts` | 1.1 | รันใน `pnpm test` — เพิ่ม model/field ใหม่แล้วเทสต์แดง = ผิดกติกา `02` §2 ไม่ใช่เทสต์พัง |
