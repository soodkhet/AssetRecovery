...
| A3 | `charge_per_tracking_round` — คิดค่าบริการต่อรอบการติดตามหรือไม่ | Service Fee Template (`12`) | เปิด (แต่ละรอบอิสระ = ตัวเลือก ก) |
| B3 | จำนวนเงินขั้นต่ำ WHT | มีแล้ว (`13` §6.4) | 1,000 บาท |
| B4 | `write_off_tolerance_satang` — เพดานตัดส่วนต่างค่าธรรมเนียมธนาคารอัตโนมัติ | ตั้งค่าบัญชี/การเงิน (`13`) | 5,000 satang |
...
| D12 | เกณฑ์ตัด advance ไม่มีใบเสร็จเป็นลูกหนี้พนักงาน | ตั้งค่าบัญชี/การเงิน (`13`) | เปิด + หักจาก payout รอบถัดไป |
