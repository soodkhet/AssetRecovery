 ...
 * ทั้งสองยังอยู่ในแค็ตตาล็อกเพื่อให้หน้าจอแสดงข้อมูลเก่า/ข้อมูลนำเข้าได้ถูกกลุ่มสี
 *
 * ✅ **มติ PO 15/08/2569 (รีวิว Phase 5 — D16)**: ถอนสองแถวนี้ออกจาก `90` §6.3 แล้ว (v2.3)
 * ⇒ ไม่ใช่ requirement ที่ค้างอยู่อีกต่อไป · จะต่อสายได้ก็ต่อเมื่อมีมติเพิ่ม
 * `payout_batch_status = 'failed'` และ `exceptions.due_date` ลง `02` ก่อน — ถึงตอนนั้นให้ต่อสาย
 * แล้วย้ายออกจากรายการนี้ในคอมมิตเดียวกัน (Rule 04)
 */
